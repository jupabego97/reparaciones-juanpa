        ...
        with neon_engine.connect() as neon_conn:
            ...
            for i, (repair_id, image_url, owner_name) in enumerate(neon_images, 1):
                try:
                    ...
                    # Usar una transacción separada para cada imagen
                    with railway_engine.begin() as railway_conn:
                        ...
                        update_result = railway_conn.execute(text("""
                            UPDATE repair_cards 
                        ...
                        if update_result.rowcount > 0:
                            ...
                            print(f"   ⚠️  No se pudo actualizar el registro")
            ...
            # Verificación final
            with railway_engine.connect() as final_conn:
                final_result = final_conn.execute(text("""
